...
export const EVENT_INSTANCES: EventInstance[] = [
  ...
  },
  {
    ...
    pendingBalance: 0,
    waitlistCount: 0,
    furyEventId: 'evt-dueling-dzs-2026',
    furyRegistrationUrl: 'https://register.furycoaching.com/registration?eventId=evt-dueling-dzs-2026',
    lookingForTeamCount: 0,
    teamsNotFullCount: 0,
  },
  {
